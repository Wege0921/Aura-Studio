      ...
      <div className="bg-aura-ink shadow rounded-lg overflow-hidden">
                ...
                <tr key={classItem.id}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      <div className="text-sm text-aura-sand">{classItem.instructor}</div>
                      <div className="text-xs text-aura-sand">{classItem.classType}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm text-aura-sand">{classItem.time}</div>
                    <div className="text-xs text-aura-sand">{classItem.duration} min</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-aura-cream">
        ...
        {classes.length === 0 && (
          <div className="text-center py-12">
            <p className="text-aura-sand">No classes found. Create your first class!</p>
          </div>
        )}
